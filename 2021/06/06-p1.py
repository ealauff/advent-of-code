...
# NOTE: There are faster ways to solve this problem,
#       but I thought it would be fun to try solving it using a recursive function

# VERY SLOW IMPLEMENTATION WIHOUT MEMOIZATION
# def calc_num_offspring(starting_age, days_left):
#     if days_left - (starting_age + 1) < 0:
#         return 0
#     else:
